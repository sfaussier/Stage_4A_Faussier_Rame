...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/cache/prod/annotations', false);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine')), 5 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetWriterCacheWarmer($this, new \Assetic\AssetWriter('D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/../web'))));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_30e6b73be15afd808fbd4207af0e3b5a');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_30e6b73be15afd808fbd4207af0e3b5a');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_30e6b73be15afd808fbd4207af0e3b5a');
        ...
        $d->setProxyDir('D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/logs/prod.log', 100, true);
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/cache/prod/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/cache/prod',
            ...
            'router.resource' => 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/cache/prod/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/cache/prod/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'D:/POLYTECH/Stage4A/gitStage4A/Application/CongesHoraires/app/cache/prod/assetic',
